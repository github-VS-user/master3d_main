...
const translations = {
  en: {
    ...
    "checkout.emailHelper": "Used for order confirmation, invoice and shipping updates only.",
    "checkout.phoneRequired": "required for 10+ items",
    "checkout.largeOrderNote": "Large orders (10+ items) may take longer to ship. We need your phone number to keep you updated.",
    "checkout.streetAddress": "Street Address",
    "checkout.zipCode": "ZIP Code",
    "checkout.selectCanton": "Select canton",
    "checkout.next": "Next",
    "checkout.paymentMethod": "Payment Method",
    "checkout.choosePayment": "Choose how you want to pay",
    "checkout.bankTransfer": "Bank Transfer (IBAN)",
    "checkout.bankTransferDesc": "Pay via bank transfer",
    "checkout.twint": "TWINT",
    "checkout.twintDesc": "Pay via TWINT mobile payment",
    "checkout.cash": "Cash on Delivery",
    "checkout.cashDesc": "Pay in cash when you receive your order (FRIENDS123 exclusive)",
    "checkout.back": "Back",
    "checkout.promoCode": "Promo Code",
    "checkout.enterPromoCode": "Enter promo code",
    "checkout.secondPromoCode": "Second promo code",
    ...
    "checkout.freeShippingNote": "Free shipping — orders over CHF 20 ship free.",
    "checkout.friendsPerk": "FRIENDS123 perk: add a second promo code",
    "checkout.cart": "Cart",
    "checkout.item": "item",
    "checkout.items": "items",
    "checkout.colourNote": "Product images may show a different colour. The colour you will receive is the one you selected, not the one shown in the image. This applies to all products.",
  ...
  fr: {
    ...
    "checkout.emailHelper": "Utilisé uniquement pour la confirmation de commande, la facture et les mises à jour d'expédition.",
    "checkout.phoneRequired": "obligatoire pour 10+ articles",
    "checkout.largeOrderNote": "Les grandes commandes (10+ articles) peuvent prendre plus de temps. Nous avons besoin de votre numéro pour vous tenir informé.",
    "checkout.streetAddress": "Adresse",
    "checkout.zipCode": "Code Postal",
    "checkout.selectCanton": "Sélectionner le canton",
    "checkout.next": "Suivant",
    "checkout.paymentMethod": "Méthode de Paiement",
    "checkout.choosePayment": "Choisissez comment payer",
    "checkout.bankTransfer": "Virement Bancaire (IBAN)",
    "checkout.bankTransferDesc": "Payer par virement bancaire",
    "checkout.twint": "TWINT",
    "checkout.twintDesc": "Payer via TWINT",
    "checkout.cash": "Paiement en Espèces",
    "checkout.cashDesc": "Payer en espèces à la livraison (exclusif FRIENDS123)",
    "checkout.back": "Retour",
    "checkout.promoCode": "Code Promo",
    "checkout.enterPromoCode": "Entrez un code promo",
    "checkout.secondPromoCode": "Deuxième code promo",
    ...
    "checkout.promoDiscount": "Remise promo",
    "checkout.freeShippingNote": "Livraison gratuite — commandes de plus de CHF 20.",
    "checkout.friendsPerk": "Avantage FRIENDS123 : ajouter un deuxième code promo",
    "checkout.cart": "Panier",
    "checkout.item": "article",
    "checkout.items": "articles",
    "checkout.colourNote": "Les images peuvent montrer une couleur différente. Vous recevrez la couleur sélectionnée. Valable pour tous les produits.",
